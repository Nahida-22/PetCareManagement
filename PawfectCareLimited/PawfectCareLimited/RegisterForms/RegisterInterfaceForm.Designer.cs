...
{ 
    partial class RegisterInterfaceForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            petNameValue = new TextBox();
            lastNameValue = new TextBox();
            phoneNumberValue = new TextBox();
            emailValue = new TextBox();
            addressValue = new TextBox();
            petTypeValue = new TextBox();
            petBreedValue = new TextBox();
            petAgeValue = new TextBox();
            registerButton = new Button();
            ownerIdLabel = new Label();
            ownerIdValue = new TextBox();
        ...
        private TextBox petNameValue;
        private TextBox lastNameValue;
        private TextBox phoneNumberValue;
        private TextBox emailValue;
        private TextBox addressValue;
        private TextBox petTypeValue;
        private TextBox petBreedValue;
        private TextBox petAgeValue;
        private Button registerButton;
        private Label ownerIdLabel;
        private TextBox ownerIdValue;
